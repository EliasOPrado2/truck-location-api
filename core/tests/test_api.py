...
class TestAPI(APITestCase):
    def setUp(self):
        ...
        self.route_data = {
            "origin": self.address.id,
            "destination": self.address2.id,
        }

        self.url_address_list = reverse("core:addresses-list")
        self.url_address_detail = reverse(
            "core:addresses-detail", kwargs={"pk": self.address.pk}
        )
        ...
        self.url_truck_driver_detail = reverse(
            "core:truck-drivers-detail", kwargs={"pk": self.truck_driver.pk}
        )
    ...
    def test_create_address(self):
        ...
        response = self.client.post(
            self.url_address_list, self.address_data, format="json"
        )
    ...
    def test_update_destination(self):
        ...
        response = self.client.put(self.url_address_detail, data, format="json")
        self.assertEqual(response.status_code, status.HTTP_200_OK)

    def test_delete_address(self):
        """Test DELETE method for Destination endpoint"""
        response = self.client.delete(self.url_address_detail, format="json")
    ...
    def test_create_truck_driver(self):
        ...
        response = self.client.post(
            self.url_truck_driver_list, self.truck_driver_data, format="json"
        )
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
    ...
    def test_update_truck_driver(self):
        ...
        response = self.client.put(self.url_truck_driver_detail, data, format="json")
        self.assertEqual(response.status_code, status.HTTP_200_OK)

    def test_delete_truck_driver(self):
        """Test DELETE method for TruckDriver endpoint"""
        response = self.client.delete(self.url_truck_driver_detail, format="json")
        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)
    ...
    def test_get_route(self):
        """Test GET method for Route nested endpoint"""
    ...
    def test_post_route(self):
        """Test POST method for Route nested endpoint"""
        truck_driver_id = self.truck_driver.id
        response = self.client.post(
            f"/api/truck-drivers/{truck_driver_id}/routes/",
            self.route_data,
            format="json",
        )
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
    ...
    def test_update_route(self):
        """Test PUT method for Route nested endpoint"""
        truck_driver_id = self.truck_driver.id
        route_id = self.route.id
        response = self.client.put(
            f"/api/truck-drivers/{truck_driver_id}/routes/{route_id}/",
            self.route_data,
            format="json",
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_delete_route(self):
        """Test DELETE method for Route nested endpoint"""
        truck_driver_id = self.truck_driver.id
        route_id = self.route.id
